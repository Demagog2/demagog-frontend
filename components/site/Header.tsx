                            ...
                            <nav className={`nav d-none d-xl-flex ${isOpen ? 'open' : ''}`}>
                                ...
                                <ul className="list menu-list d-flex flex-column flex-xl-row align-items-start align-items-xl-center px-5 p-xl-0">
                                    ...
                                    <NavSubItem title="Sliby">
                                        <ul
                                            className="dropmenu-wrap d-flex flex-column flex-xl-row flex-xl-flex justify-content-start justify-content-xl-center flex-wrap list py-2 py-xl-8"
                                        >
                                            <NavSubLink title="Sliby vlády Andreje Babiše (2018—2021)" url="/sliby/druha-vlada-andreje-babise" /> 
                                            <NavSubLink title="Sliby prezidenta Miloše Zemana (2013—2018)" url="https://zpravy.aktualne.cz/domaci/zverejnujeme-velkou-inventuru-zemanovych-slibu-ktere-slovo-d/r~9ebe8728ff6911e7adc2ac1f6b220ee8/" />
                                        </ul>
                                    </NavSubItem>
                                </ul>
                            </nav>
