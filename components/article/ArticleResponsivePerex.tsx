...
export function ArticleResponsivePerex(props: {
  ...
  return (
    ...
    >
      <span
        className={classNames({
          'fs-9 fs-md-8 lh-md-base d-xl-none': props.isEmbedded,
      ...
      {props.isEmbedded && (
        <span className="fs-9 fs-md-8 lh-md-base d-none d-xl-block d-xxl-none">
          {perexLarge}
        </span>
      )}
      {props.isEmbedded && (
        <span className="fs-9 fs-md-8 lh-md-base d-none d-xxl-block">
          {perexXLarge}
        </span>
      )}
    </div>
