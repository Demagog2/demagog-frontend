...
export function SearchButton(props: { color?: 'white' }) {
  return (
    <button
      type="submit"
      className={classNames(
        'search-btn d-flex align-items-center justify-content-center right top w-50px',
    ...
    >
      ...
      >
        <path
          ...
          fill={props.color === 'white' ? '#fff' : '#3c325c'}
