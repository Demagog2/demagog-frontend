          ...
          <div className="px-4 sm:px-6 lg:px-8 text-sm">
            <div className="flex flex-col gap-8 sm:flex-row">
              ...
              <div className="flex-auto">
                ...
                <table className="w-full max-w-xl divide-y divide-gray-300 border-collapse border-spacing-y-2 mt-6 text-gray-600">
                  <thead>
                    <tr className="border-b border-gray-300">
                      <th className="text-left py-2 font-semibold">Členové</th>
                    </tr>
                  </thead>
