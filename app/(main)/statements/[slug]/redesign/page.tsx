          ...
          <div className="mt-10">
            ...
            <div className="mt-6 bg-lightgrey radius-22px text-start px-4 px-md-6">
              ...
              <div className="row justify-content-center justify-content-md-start g-4 g-md-6">
                {/* Avatar Section */}
                <div className="col-3 d-flex flex-column align-items-center mt-4 mb-2 mb-md-3">
                  <SourceSpeakerAvatar
                    statement={statement}
                    isEmbedded={true}
                  />
              ...
              <div className="row justify-content-center justify-content-md-end g-4 g-md-6">
                <div className="col-12 col-md-9 align-self-center mt-md-8">
                  ...
                  <div className="mt-3 mb-3">
                    <p>
                      Jasný postoj ke společné evropské měně má více stran.
                      Hnutí ANO i SPD jasně deklarovaly, že euro odmítají,
                      dlouhodobě se proti němu staví i ODS.
                    </p>
                    <div className="col-md-8 mt-4 d-flex justify-content-between align-items-center">
                      ...
                      <div>
                        <PermanentLink href={'/vyrok/23657/redesign'} />
                      </div>
                    </div>
                  </div>
                </div>
